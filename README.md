...
![Version: 1.19.7-bb.1](https://img.shields.io/badge/Version-1.19.7--bb.1-informational?style=flat-square) ![AppVersion: 1.1.0](https://img.shields.io/badge/AppVersion-1.1.0-informational?style=flat-square)
...
| anchoreAnalyzer.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreApi.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreCatalog.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchorePolicyEngine.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreSimpleQueue.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEngineUpgradeJob.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchore-feeds-gem-db.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseFeeds.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseFeedsUpgradeJob.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseRbac.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseReports.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseNotifications.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseUi.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchoreEnterpriseEngineUpgradeJob.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
