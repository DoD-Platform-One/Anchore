...
![Version: 2.4.2-bb.10](https://img.shields.io/badge/Version-2.4.2--bb.10-informational?style=flat-square) ![AppVersion: 5.4.1](https://img.shields.io/badge/AppVersion-5.4.1-informational?style=flat-square)
...
Kubernetes: `1.23.x - 1.29.x || 1.23.x-x - 1.29.x-x`
...
| feeds.anchoreConfig.metrics.enabled | bool | `false` |  |
...
| feeds.feeds-db.image.tag | string | `"13.12"` |  |
...
| feeds.feeds-db.securityContext.fsGroup | int | `26` |  |
| feeds.feeds-db.securityContext.runAsUser | int | `26` |  |
| feeds.feeds-db.securityContext.runAsGroup | int | `26` |  |
| feeds.feeds-db.containerSecurityContext.enabled | bool | `true` |  |
| feeds.feeds-db.containerSecurityContext.runAsUser | int | `26` |  |
| feeds.feeds-db.containerSecurityContext.runAsGroup | int | `26` |  |
...
| feeds.feeds-db.primary.podSecurityContext.fsGroup | int | `26` |  |
| feeds.feeds-db.primary.podSecurityContext.runAsUser | int | `26` |  |
| feeds.feeds-db.primary.podSecurityContext.runAsGroup | int | `26` |  |
| feeds.feeds-db.primary.containerSecurityContext.enabled | bool | `true` |  |
| feeds.feeds-db.primary.containerSecurityContext.runAsUser | int | `26` |  |
| feeds.feeds-db.primary.containerSecurityContext.runAsGroup | int | `26` |  |
...
| feeds.gem-db.image.tag | string | `"13.12"` |  |
...
| feeds.gem-db.securityContext.fsGroup | int | `26` |  |
| feeds.gem-db.securityContext.runAsUser | int | `26` |  |
| feeds.gem-db.securityContext.runAsGroup | int | `26` |  |
...
| feeds.gem-db.primary.podSecurityContext.fsGroup | int | `26` |  |
| feeds.gem-db.primary.podSecurityContext.runAsUser | int | `26` |  |
| feeds.gem-db.primary.podSecurityContext.runAsGroup | int | `26` |  |
| feeds.gem-db.primary.containerSecurityContext.enabled | bool | `true` |  |
| feeds.gem-db.primary.containerSecurityContext.runAsUser | int | `26` |  |
| feeds.gem-db.primary.containerSecurityContext.runAsGroup | int | `26` |  |
