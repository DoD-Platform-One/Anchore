...
![Version: 2.0.2-bb.1](https://img.shields.io/badge/Version-2.0.2--bb.1-informational?style=flat-square) ![AppVersion: 4.9.3](https://img.shields.io/badge/AppVersion-4.9.3-informational?style=flat-square)
...
Kubernetes: `1.23.x - 1.28.x || 1.23.x-x - 1.28.x-x`
...
| image | string | `"registry1.dso.mil/ironbank/anchore/enterprise/enterprise:4.9.3"` |  |
...
| feeds.enabled | bool | `false` |  |
| feeds.standalone | bool | `false` |  |
| feeds.url | string | `""` |  |
| feeds.service.port | int | `8448` |  |
| feeds.image | string | `"registry1.dso.mil/ironbank/anchore/enterprise/enterprise:4.9.3"` |  |
...
| feeds.anchoreConfig.metrics.enabled | bool | `true` |  |
| feeds.anchoreConfig.metrics.auth_disabled | bool | `false` |  |
| anchore-feeds-db.enabled | bool | `true` |  |
...
| anchore-feeds-db.postgresUser | string | `"anchore"` |  |
...
| anchore-feeds-db.primary.persistence.resourcePolicy | string | `"keep"` |  |
| anchore-feeds-db.primary.persistence.size | string | `"20Gi"` |  |
| anchore-feeds-db.primary.persistence.subPath | string | `"pgdata"` |  |
| anchore-feeds-db.primary.persistence.mountPath | string | `"/var/lib/postgresql"` |  |
| anchore-feeds-db.primary.postgresqlDataDir | string | `"/var/lib/postgresql/data"` |  |
| anchore-feeds-db.primary.podSecurityContext.enabled | bool | `true` |  |
| anchore-feeds-db.primary.podSecurityContext.fsGroup | int | `26` |  |
| anchore-feeds-db.primary.podSecurityContext.runAsUser | int | `26` |  |
| anchore-feeds-db.primary.podSecurityContext.runAsGroup | int | `26` |  |
| anchore-feeds-db.primary.containerSecurityContext.enabled | bool | `true` |  |
| anchore-feeds-db.primary.containerSecurityContext.runAsUser | int | `26` |  |
| anchore-feeds-db.primary.containerSecurityContext.runAsGroup | int | `26` |  |
| anchore-feeds-db.primary.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| anchore-feeds-gem-db.enabled | bool | `true` |  |
| anchore-feeds-gem-db.image.registry | string | `"registry1.dso.mil"` |  |
| anchore-feeds-gem-db.image.repository | string | `"ironbank/opensource/postgres/postgresql"` |  |
| anchore-feeds-gem-db.image.tag | string | `"13.12"` |  |
...
| anchore-feeds-gem-db.postgresUser | string | `"anchore"` |  |
...
| anchore-feeds-gem-db.primary.podSecurityContext.fsGroup | int | `26` |  |
| anchore-feeds-gem-db.primary.podSecurityContext.runAsUser | int | `26` |  |
| anchore-feeds-gem-db.primary.podSecurityContext.runAsGroup | int | `26` |  |
| anchore-feeds-gem-db.primary.containerSecurityContext.enabled | bool | `true` |  |
| anchore-feeds-gem-db.primary.containerSecurityContext.runAsUser | int | `26` |  |
| anchore-feeds-gem-db.primary.containerSecurityContext.runAsGroup | int | `26` |  |
| anchore-feeds-gem-db.primary.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| rbacAuth.enabled | bool | `true` |  |
| rbacAuth.extraEnv[0].name | string | `"AUTHLIB_INSECURE_TRANSPORT"` |  |
| rbacAuth.extraEnv[0].value | string | `"true"` |  |
| rbacAuth.resources.limits.cpu | int | `1` |  |
| rbacAuth.resources.limits.memory | string | `"1G"` |  |
| rbacAuth.resources.requests.cpu | int | `1` |  |
| rbacAuth.resources.requests.memory | string | `"1G"` |  |
| rbacManager.replicaCount | int | `1` |  |
| rbacManager.service.type | string | `"ClusterIP"` |  |
| rbacManager.service.port | int | `8229` |  |
| rbacManager.service.annotations | object | `{}` |  |
| rbacManager.service.labels | object | `{}` |  |
| rbacManager.service.nodePort | string | `""` |  |
| rbacManager.extraEnv[0].name | string | `"AUTHLIB_INSECURE_TRANSPORT"` |  |
| rbacManager.extraEnv[0].value | string | `"true"` |  |
| rbacManager.resources.limits.cpu | int | `1` |  |
| rbacManager.resources.limits.memory | string | `"4G"` |  |
| rbacManager.resources.requests.cpu | int | `1` |  |
| rbacManager.resources.requests.memory | string | `"4G"` |  |
| rbacManager.labels | object | `{}` |  |
| rbacManager.annotations | object | `{}` |  |
...
| ui.image | string | `"registry1.dso.mil/ironbank/anchore/enterpriseui/enterpriseui:4.9.0"` |  |
