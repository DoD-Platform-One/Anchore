...
![Version: 2.7.0-bb.4](https://img.shields.io/badge/Version-2.7.0--bb.4-informational?style=flat-square) ![AppVersion: 5.7.0](https://img.shields.io/badge/AppVersion-5.7.0-informational?style=flat-square)
...
| image | string | `"registry1.dso.mil/ironbank/anchore/enterprise/enterprise:5.7.0"` |  |
...
| feeds.image | string | `"registry1.dso.mil/ironbank/anchore/enterprise/enterprise:5.7.0"` |  |
...
| ui.image | string | `"registry1.dso.mil/ironbank/anchore/enterpriseui/enterpriseui:5.7.0"` |  |
...
| upgradeJob.kubectlImage | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.29.7"` |  |
...
| osaaMigrationJob.kubectlImage | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.29.7"` |  |
